...
contract TokenVesting is Ownable, ReentrancyGuard {
    ...
    struct VestingSchedule {
        ...
        uint256 cliff;
        // amount that needs to be released on cliff
        uint256 releaseAfterCliff;
    ...
    function _computeReleasableAmount(
        ...
        // Otherwise, some tokens are releasable.
            ...
            uint256 vestedAmount = vestingSchedule.releaseAfterCliff +
                ((vestingSchedule.amountTotal -
                    vestingSchedule.releaseAfterCliff) * vestedSeconds) /
